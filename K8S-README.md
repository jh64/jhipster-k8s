...
```
$ docker image tag myappws u20041-kworker3-dev:5000/myappws
$ docker push u20041-kworker3-dev:5000/myappws
```
...
```
$ kubectl get svc myappws -n jd-n1
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n jd-n1
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n jd-n1
```
