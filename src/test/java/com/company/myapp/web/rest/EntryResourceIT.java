...
import com.company.myapp.MyAppWsApp;
import com.company.myapp.domain.Entry;
import com.company.myapp.repository.EntryRepository;
 ...
 */
@SpringBootTest(classes = MyAppWsApp.class)
